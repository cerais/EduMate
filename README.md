...
>Разработка плана для грамотного распределения времени
...
<img src="https://sun9-41.userapi.com/impg/ymezonup4ieka2UyiM04d8E1tpH0HtHxoEHWqg/CbQebnhLX88.jpg?size=1185x364&quality=95&sign=bfb6b6008db383de046348cbcebb6517&type=album" alt="Описание" width="800" height="250">
...
В нашем проекте мы применили мощные **инструменты** и **библиотеки** для создания функционального бэкенда, который обрабатывает видео и генерирует текстовые конспекты. Вот основные компоненты используемые для нашего стека:
 ...
 - #### _**FastAPI**_ — мы использовали этот фреймворк для создания высокопроизводительного и удобного API, который обеспечивает быструю и надежную работу нашего сервиса.
 - #### _**Requests**_ — с помощью этой библиотеки мы осуществляем HTTP-запросы для скачивания видео с Яндекс Диска. Также мы реализовали обработку ошибок, что позволяет избежать сбоев в работе приложения.
 - #### _**Vosk**_ — эта библиотека помогает нам преобразовать аудиофайлы формата WAV в текст, что является важным этапом в создании конспектов.
 - #### _**MoviePy**_ — мы использовали MoviePy для конвертации видеофайлов формата MP4 в WAV, что упрощает дальнейшую обработку аудио.
 - #### _**MistralAI**_ — этот инструмент позволяет нам создавать конспекты и карточки на основе извлеченного текста, что делает процесс обучения более эффективным.
 - #### _**PyAlex**_ — с помощью этой библиотеки мы извлекаем ключевые темы из текстов и находим ссылки на дополнительные материалы, что помогает пользователям углублять свои знания по интересующим их вопросам.
...
Для основной работы мы выбрали тестовую модель Mister Large Latest.

**Mistral Large Latest** — это мощный инструмент для суммаризации текста, который позволяет эффективно обрабатывать большие объемы информации и представлять ключевые идеи в сжатом виде. Благодаря своим продвинутым алгоритмам, эта модель способна выделять основные моменты и формулировать их так, чтобы сохранить смысл и контекст оригинального материала.

<img src="https://sun7-18.userapi.com/impg/dE5QqJXGj0_3Hc3rBxJpSwI2kPAo39I33lNC2A/1rWrEw4VPi0.jpg?size=957x485&quality=95&sign=4012f8693fb90b4fafa8b82cfd892078&type=album" alt="Описание" width="600" height="300">

Анализируя данную анаграмму, можно сказать, что Mistral Large показывает высокие результаты в широко используемых тестах, что делает его второй по популярности моделью в мире, доступной через API (после GPT-4).

### Общая характеристика

- *Владеет 12 разговорными языками*

- *Знает более 80 языков программирования( в их числе: Python, C++, Java и др.)*

- *Длина контекста: 32 000 токенов*

- *Точность работы: 98%*

### Основные причины выбора данной ML

- Модель занимает 2 место по MMLU

- Не требует денежных затрат
   
- Не требовательна к железу: GPT-4 имеет 500 млрд параметров, а Mastral 7млн
  
С помощью Mistral Large Latest вы можете быстро получить лаконичное резюме, которое выделяет самые важные аспекты, облегчая восприятие информации. Это особенно полезно для студентов, исследователей и профессионалов, которым нужно быстро ориентироваться в больших объемах текста.

### ***3. Проектирование системы***

- Архитектура

<img src="https://sun9-54.userapi.com/impg/Wok9veC6DfeNotm_W52KZPby8oUeFZ6_bRQGbQ/NvPjL09cTIQ.jpg?size=1174x419&quality=95&sign=b309427c963740b728eb656b36ee8550&type=album" alt="Описание" width="800" height="300">
...
|                                                    |                                                                |
|----------------------------------------------------|----------------------------------------------------------------|
|<img src="https://sun9-74.userapi.com/impg/FNIYDYM1gdl5dNMS9uXbCAwGToPinzwT5nxrvQ/i20DiNEdzto.jpg?size=1440x1024&quality=95&sign=3111d5e68f571de51c6502e9f0d25ea3&type=album" alt="Описание" width="400" height="300">|  <img src="https://sun9-53.userapi.com/impg/3Z3oNuI1wV2IVcCYj603oSYNjrZ3bg5feKijsw/qDycMfpNoEc.jpg?size=1440x1024&quality=95&sign=76402e30b669f6c22e7d26237a3575e9&type=album" alt="Описание" width="400" height="300">         |
 <img src="https://sun9-6.userapi.com/impg/vkHhZxNhDavYqb-1Ac8zO88IFiQNrjrVZYh_9g/uWe9p0Hb27Q.jpg?size=1440x1024&quality=95&sign=56eed8a9df7ae4f66fa6a68f83877daf&type=album" alt="Описание" width="400" height="300">| <img src="https://sun9-70.userapi.com/impg/BVbrVCvSnsxyGSLY01fyA0Gyu29FfkR0nHjLqg/i6y_Q1qHGjU.jpg?size=1440x1024&quality=95&sign=42ede5774b8d01b66a71be9eac663602&type=album" alt="Описание" width="400" height="300">        |         
|<img src="https://sun9-70.userapi.com/impg/cwjeDD7wJ-AMwFdSY3RI11XvqKO_Twk6mFhEVw/nQvaT57M98w.jpg?size=1440x1024&quality=95&sign=56550bbe3488981a62c0d88206dfec88&type=album" alt="Описание" width="400" height="300">|<img src="https://sun7-19.userapi.com/impg/tOFR5MrGLGH8pMP-UcMHz56tvqoxTwi6HNUHtQ/qN9halHJZvA.jpg?size=1440x1024&quality=95&sign=f882dd7a9ab991021ed460941705cb1d&type=album" alt="Описание" width="400" height="300">|
...
# Дополнительное задание на второй этап отбора

>В рамках второго этапа мы реализовали скрипт, написанный на FastAPi, в котором:

- Реализована выгрузка видео с Яндекс.Диска по ссылке при помощи библиотеки requests.

- Создан скрипт для скачивания, конвертации .mp4 в .wav и транскрипции в текст.

- Реализован скрипт для суммаризации с Mastral-lagre-latest.

- Система полностью работает.

### В приложенной папке fastAPI подробно представлен и описан процесс выполнения задачи

# Обратная связь

Для обратной связи обращайтесь на почту:

**kvntrmforissues@mail.ru**
